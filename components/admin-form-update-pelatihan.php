<?php
if (isset($_POST['updatePelatihanAdmin'])) {
    // cek apakah data berhasil diedit atau tidak
    if (updatePelatihanAdmin($_POST) > 0) {
        echo "
          <script>
...
<button type="button" class="btn btn-success" data-bs-toggle="modal"
    data-bs-target="#updatePelatihanAdmin<?php echo $row['id']; ?>">
    <i class="bi bi-pencil-square"></i>
</button>

<!-- Modal -->
<div class="modal fade" id="updatePelatihanAdmin<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="updatePelatihanAdmin" class="btn btn-primary">Simpan</button>
                </div>
