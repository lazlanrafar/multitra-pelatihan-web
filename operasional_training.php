...
<head>
    ...
    <title>Operasional Training</title>
...
<body>
    ...
    <div id="content-area">
        ...
        <div class="content-text">
            <main class="col-xl-12 px-md-4">
                <div
                    class="justify-content-between flex-wrap flex-md-nowrap align-items-center  pb-2 mb-3 border-bottom margin:-30px">
                    <h1 style="margin-top:-10px; margin-left:10px;" class="h2">Operasional Training</h1>
                ...
                <div class="table-responsive; scroll">
                    <table class="table table-bordered mt-2" border="3" cellpadding="1" cellspacing=""
                        width="100px" ; style="margin-top:-100px;">
                        <thead border="4">
                            ...
                            <tr align="center" border="4">
                                ...
                                <th href="registrasi.php"
                                    style="font-size:11px; vertical-align:center; background-color:white">Kegiatan</th>
                                ...
                                <th style="font-size:11px; background-color:white">Tanggal Aktual Permohonan</th>
                                <th style="font-size:11px; background-color:white">Tanggal Target Permohonan</th>
                                <th style="font-size:11px; background-color:white">Permohonan Izin Pelatihan ke Teman
                                    K3</th>
                                <th style="font-size:11px; background-color:white">Tanggal Aktual Input Peserta</th>
                                <th style="font-size:11px; background-color:white">Tanggal Target Input Peserta</th>
                                <th style="font-size:11px; background-color:white">Input Peserta</th>
                                <th style="font-size:11px; background-color:white">Submit Data Peserta</th>
                        ...
                        <tbody>
                            ...
                            <tr align="center">
                                ...
                                <td style="font-size:13px;"><button type="button"
                                        class="btn <?= !$row['keterangan'] ? 'btn-primary' : 'btn-warning' ?>"
                                        data-bs-toggle="modal" data-bs-target="#cekModal<?php echo $row['id']; ?>">
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="cekModal<?php echo $row['id']; ?>" tabindex="-1"
                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" type="text" cols="20" rows="5" disabled name="keterangan"
                                                            id="keterangan" required autocomplete="off"><?php echo $row['keterangan']; ?></textarea>
                                                    </div>
                                                </div>
    ...
    <td>
        ...
        <!-- Modal -->
        <div class="modal fade" id="editModalid<?php echo $row['id']; ?>" tabindex="-1"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-body text-start">
                            ...
                            <div class="mb-3">
                                ...
                                <Input class="form-control" type="text" name="nama_kegiatan" id="nama_kegiatan"
                                    required disabled value="<?php echo $row['nama_kegiatan']; ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <Input class="form-control" type="date" name="tanggal_mulai" id="tanggal_mulai"
                                    required disabled value="<?php echo $row['tanggal_mulai']; ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <Input class="form-control" type="date" name="tanggal_selesai"
                                    id="tanggal_selesai" required disabled value="<?php echo $row['tanggal_selesai']; ?>">
                            </div>

                            <div class="mb-3">
                                <label class="form-label text-start" for="jumlah_peserta">Jumlah Peserta </label>
                                <Input class="form-control" type="text" name="jumlah_peserta" id="jumlah_peserta"
                                    required disabled value="<?php echo $row['jumlah_peserta']; ?>">
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="status_kegiatan" class="form-label">Status
                                    Kegiatan</label>
                                <select class="form-select" aria-label="Default select example"
                                    name="status_kegiatan" disabled value="<?php echo $row['status_kegiatan']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <Input class="form-control" type="date" name="tgl_aktual_serti"
                                    id="tgl_aktual_serti" required value="<?php echo $row['tgl_aktual_serti']; ?>">
                            </div>

                            <div class="mb-3">
                                <label class="form-label text-start" for="tgl_aktual_dok">Tanggal Aktual Dokumen
                                </label>
                                <Input class="form-control" type="date" name="tgl_aktual_dok" id="tgl_aktual_dok"
                                    required value="<?php echo $row['tgl_aktual_dok']; ?>">
                            </div>
