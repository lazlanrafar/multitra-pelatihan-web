    ...
    <div class="main-menu">
        ...
        <?php 
				if ($_SESSION['user_akses'] == 'Admin Operasional') {
					?>
        <a href="admin-operasional.php"><i class="fa fa-phone"></i>Admin Operasional</a>
        <?php
				}
			?>

        <a href="logout.php" class="btn btn-danger"
            style="position: absolute; bottom:0; padding: 10px;left: 50%; transform: translateX(-50%);">Log Out <i
