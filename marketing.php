...
<body>
    ...
    <div class="content-text">
      <main class="col-xl-12 px-md-4">
        <div class="justify-content-between flex-wrap flex-md-nowrap align-items-center  pb-2 mb-3 border-bottom margin:-30px">
          <h1 style="margin-top:-10px; margin-left:10px;" class="h2">Marketing</h1>
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-top:-110px; margin-left:10px; padding:5px; ">
              ...
              <form action="" method="post">
                ...
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                    ...
                    <Input class="form-control" type="text" name="nama_kegiatan" id="nama_kegiatan" required autocomplete="off">
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <Input class="form-control" type="text" name="jumlah_peserta" id="jumlah_peserta" required autocomplete="off">
                  </div>

                  <div class="mb-3">
                    <label class="form-label" for="exampleInputPassword1" class="form-label">Status Kegiatan</label>
          ...
          <table class="table table-bordered mt-2" border="3" cellpadding="1" cellspacing="" width="100px" ; style="margin-top:-100px;">
            <thead border="4">
              ...
              <tr align="center" border="4">
                ...
                <th style="font-size:11px; background-color:white" colspan="2">Aksi</th>
              </tr>
          ...
          <form action="" method="post">
            <div class="modal-body text-start">
              ...
              <div class="mb-3">
                ...
                <Input class="form-control" type="text" name="nama_kegiatan" id="nama_kegiatan" required value="<?php echo $row["nama_kegiatan"]; ?>" autocomplete="off">
              </div>

              <div class="mb-3">
                <label class="form-label text-start" for="tanggal_mulai">Tanggal Mulai </label>
                <Input class="form-control" type="date" name="tanggal_mulai" id="tanggal_mulai" required value="<?php echo $row["tanggal_mulai"]; ?>">
              </div>

              <div class="mb-3">
                <label class="form-label text-start" for="tanggal_selesai">Tanggal Selesai </label>
                <Input class="form-control" type="date" name="tanggal_selesai" id="tanggal_selesai" required value="<?php echo $row["tanggal_selesai"]; ?>">
              </div>

              <div class="mb-3">
                <label class="form-label text-start" for="jumlah_peserta">Jumlah Peserta </label>
                <Input class="form-control" type="text" name="jumlah_peserta" id="jumlah_peserta" required value="<?php echo $row["jumlah_peserta"]; ?>">
              </div>

              <div class="mb-3">
                <label class="form-label" for="status_kegiatan" class="form-label">Status Kegiatan</label>
                <select class="form-select" aria-label="Default select example" name="status_kegiatan" value="<?php echo $row["status_kegiatan"]; ?>">
  ...
  <td>
    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalHapus<?php echo $row["id"]; ?>">
    ...
    <div class="modal fade" id="modalHapus<?php echo $row["id"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <a href="hapus.php?id=<?= $row["id"] ?>" type="submit" class="btn btn-danger">Hapus</a>
          </div>
        </div>
      </div>
    </div>
